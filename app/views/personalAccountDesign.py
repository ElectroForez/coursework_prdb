...
"background-color: rgb(38, 162, 105);")
        ...
        self.add_good_btn = QtWidgets.QPushButton(self.centralwidget)
        self.add_good_btn.setObjectName("add_good_btn")
        self.mainLayout.addWidget(self.add_good_btn)
        ...
        self.close_order_btn = QtWidgets.QPushButton(self.centralwidget)
        self.close_order_btn.setObjectName("close_order_btn")
        self.mainLayout.addWidget(self.close_order_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_good_btn.setText(_translate("MainWindow", "Добавить товар"))
        self.create_order_btn.setText(_translate("MainWindow", "Создать заказ"))
        self.close_order_btn.setText(_translate("MainWindow", "Закрыть заказ"))
